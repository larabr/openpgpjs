...
describe('Unit Tests', function () {
  ...
  if (typeof window !== 'undefined') {
    // Safari 14.1.* and 15.* seem to have issues handling rejections when their native TransformStream implementation is involved,
    // so for now we ignore unhandled rejections for those browser versions.
    if (!window.navigator.userAgent.match(/Version\/1(4|5)\.\d(\.\d)* Safari/)) {
